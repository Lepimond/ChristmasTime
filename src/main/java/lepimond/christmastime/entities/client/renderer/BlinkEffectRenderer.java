...
public class BlinkEffectRenderer extends EntityRenderer<BlinkEffect> {
    ...
    public void render(BlinkEffect entity, float p_115419_, float p_115420_, PoseStack p_115421_, MultiBufferSource source, int p_115423_) {
        super.render(entity, p_115419_, p_115420_, p_115421_, source, p_115423_);
